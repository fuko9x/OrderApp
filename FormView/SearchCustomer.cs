...
namespace OrderApp.FormView
{
    public partial class SearchCustomer : MaterialForm
    {
        ...
        private void MenuItemCongno_Click(object sender, EventArgs e)
        {
            ...
            xlWorkBook.SaveAs(Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) + "\\Template\\CongNo.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
